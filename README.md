...
*For the Frontend we chose to use HTML,CSS and JavaScript
*or the backend part we use Javascript and API
*and we use user Interface(UI) and user Experience(UX)
